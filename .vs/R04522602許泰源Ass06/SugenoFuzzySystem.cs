...
namespace R04522602許泰源Ass06{
	class SugenoFuzzySystem : FuzzyInferenceSystem{
		public SugenoFuzzySystem(List<IfThenFuzzyRule> all) : base(all){
			;
		}
		...
		{
			throw new Exception("No implementation of FuzzyInFuzzyOutInferencing() for SugenoFuzzySystem");
		}
	}
}
